...
define( 'PLUGINS_PATH', get_template_directory(). '/vendor/contact-information-widget/');

add_action( 'wp_enqueue_scripts', 'add_script_css_js_fonts' );
function add_script_css_js_fonts() {
	wp_enqueue_style('font-awesome', get_template_directory_uri(). '/vendor/contact-information-widget/fonts/font-awesome.css');
	wp_enqueue_style('style', get_template_directory_uri() . '/vendor/contact-information-widget/style.css');
          ...
          /*
								...
								$output .='<div class="ciw_email">
          						...
          						$output .= '<div class="media align-items-center mb-2">
                                          <i class="max-width-7 mr-3 fa fa-map-marker"></i>
                                          <div class="media-body">
                                            '.nl2br(stripslashes($instance['address'])).'	
                                          </div>
                                        </div>';
          
                                $output .= '<div class="media align-items-center mb-2">
                                				<i class="max-width-7 mr-3 fa fa-phone"></i>
                                                	<div class="media-body">
          						   ...
          						   $output .= '<div class="media align-items-center mb-2">
                                				<i class="max-width-7 mr-3 fa fa-envelope"></i>
                                                	<div class="media-body">
                                                    	<a href="mailto:'.$instance['contact_email'].'" target="_blank">'.$instance['contact_email'].'</a>
                                                </div>
                                           </div>';
